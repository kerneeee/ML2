...
g.aic<-round(AIC(gam17.4),1)
g.bic<-round(BIC(gam17.4),1)
g.pred<-predict(gam17.4,newdata=RiceFarms[test,])
g.df<-round(df.residual(gam17.4),1)
g.rsq<-round(r_sq_test(exp(g.pred),RiceFarms$goutput[test]),3)
g.mse<-round(MSE(gam17.4,RiceFarms,test),4)
