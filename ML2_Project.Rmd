...
## 3.2 Model Selection
For retrieving our final model we make use of an approach called forward selection.
...
s()
family = gaussian(link = "identity") (default)
The default degree of 3 yields a cubic spline.
